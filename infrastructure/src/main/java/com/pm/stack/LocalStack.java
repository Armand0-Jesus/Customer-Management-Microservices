  ...
  public LocalStack(final App scope, final String id, final StackProps props){
    ...
    FargateService authService =
        createFargateService("AuthService",
            ...
            List.of(4005),
            authServiceDb,
            Map.of("JWT_SECRET", java.util.Objects.requireNonNull(System.getenv("JWT_SECRET"), "JWT_SECRET must be set")));

    authService.getNode().addDependency(authDbHealthCheck);
    authService.getNode().addDependency(authServiceDb);

    FargateService paymentProfileService =
        createFargateService("PaymentProfileService",
    ...
    customerService.getNode().addDependency(paymentProfileService);
